...
Delete them at the first weekly refresh under [`docs/demo.md`](../demo.md) after every environment has moved past
that migration, keeping any fixture a surviving proof still reads.
