export function withPaymentRecoveryCleanup(cleanup, requestId) {
  ...
  delete from public.booking_confirmation_notification_attempts where notification_id in (select notification_id from public.booking_confirmation_notification_work where booking_request_id='${requestId}');
  ...
  delete from public.fictional_booking_confirmation_notification_effects where booking_request_id='${requestId}';
  ...
  delete from public.booking_confirmation_notification_work where booking_request_id='${requestId}';
