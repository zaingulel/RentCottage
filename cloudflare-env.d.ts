/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare-env.d.ts` (hash: 2bfa7ba38b93dd65d77c6fd99d404f15)
...
interface __BaseEnv_Env {
	...
	SUPABASE_PUBLISHABLE_KEY?: "local-test-only" | "local-development-only";
}
declare namespace Cloudflare {
	...
	interface TestEnv {
		...
		SUPABASE_PUBLISHABLE_KEY: "local-test-only";
	}
