...
The sweep is repo-wide and provider-neutral: the shared skills (`.agents/skills/`, copied whole into
`.claude/skills/`), the Claude surfaces (`CLAUDE.md`, `.claude/rules/*` when present, `.claude/agents/`,
