...
select set_config('request.jwt.claims','{"sub":"36000000-0000-4000-8000-000000000005"}',true);
select throws_ok($$select public.get_messaging_moderation(null,null,null,50)$$,'42501',null,'support with missing assurance cannot use the moderation projection');
select set_config('request.jwt.claims','{"sub":"36000000-0000-4000-8000-000000000005","aal":null}',true);
select throws_ok($$select public.get_messaging_moderation(null,null,null,50)$$,'42501',null,'support with null assurance cannot use the moderation projection');
