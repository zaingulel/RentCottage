...
select set_config('request.jwt.claim.sub','10000000-0000-4000-8000-000000001002',true);
select is((select item->>'cancelled' from public.list_confirmed_booking_history() item limit 1),'true','retained history identifies cancellation before opening detail');
