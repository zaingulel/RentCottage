...
const en = {
  ...
  componentUnavailable: "Unavailable because a component Shift is committed",
...
const ar: Copy = {
  ...
  pendingHold: "حجز معلّق",
  confirmedBooking: "حجز مؤكد",
  componentUnavailable: "غير متاح لأن إحدى المناوبات ملتزم بها",
...
const ckb: Copy = {
  ...
  pendingHold: "گرتنی چاوەڕوان",
  confirmedBooking: "حجزی پشتڕاستکراو",
  componentUnavailable: "بەردەست نییە چونکە شیفتێکی پێکهێنەر پابەندکراوە",
  bookingReference: "ژمارەی سەرچاوەی حجز",
