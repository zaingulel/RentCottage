...
const messages = {
  en: {
    ...
    party: "Party size",
    price: "Original booking price",
    fee: "Service fee",
    total: "Customer total",
    commission: "Original commission",
    net: "Original owner share",
    rules: "House Rules",
    terms: "Booking terms",
  ...
  ar: {
    ...
    price: "سعر الحجز الأصلي",
    fee: "رسوم الخدمة",
    total: "إجمالي العميل",
    commission: "العمولة الأصلية",
    net: "حصة المالك الأصلية",
    rules: "قواعد البيت",
    terms: "شروط الحجز",
  ...
  ckb: {
    ...
    period: "ماوەی حجز",
    party: "ژمارەی کەسان",
    price: "نرخی سەرەتایی حجز",
    fee: "کرێی خزمەتگوزاری",
    total: "کۆی گشتی کڕیار",
    commission: "کۆمسیۆنی سەرەتایی",
    net: "بەشی سەرەتایی خاوەن",
